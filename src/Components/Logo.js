...
const Logo = () => {
  ...
  return (
    <Wrap onClick={() => navigate("/home")}>
      <svg viewBox="0 0 367 422" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="Frame5">
          ...
          <text id="Hwang" fill="black" xmlSpace="preserve" style={{ whiteSpace: "pre" }}  fontSize="30" fontStyle="italic" letterSpacing="0em">
